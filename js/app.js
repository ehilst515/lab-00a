...
function displayPics(){
  ...
  // Setting `rando` with `let` makes it a local variable on the block level. The makeRandom() function is not local to the displayPics() block, so it's not able to be referenced within the displayPics() block
  console.log(viewed);
